📘 SQL Practice Workspaces – Oracle MySQL 21c Express Edition

This repository contains seven hands-on SQL practice work samples created while learning and experimenting with Oracle MySQL 21c Express Edition. All outputs were captured directly from the SQL terminal using the SPOOL command, ensuring an authentic reflection of real-time queries, errors, corrections, and final results.

These files demonstrate my self-driven learning process across core SQL areas, including DDL, DML, DQL, constraints, relationships, views, and a mini project.
...
This repository serves as a structured collection of my self-practiced SQL learning. Each workspace reflects hands-on exploration of SQL syntax, real problem-solving, and working with actual Oracle database behaviors.
...
This repository is purely for educational and practice purposes. Suggestions or improvements to structure, formatting, or additional practice modules are welcome.
